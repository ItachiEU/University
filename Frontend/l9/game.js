...
;
const elixirDifficulty = ["Unknown", "Advanced", "Moderate", "Beginner", "OrdinaryWizardingLevel", "OneOfAKind"];
const spellTypes = ["None", "Charm ", "Conjuration", "Spell", "Transfiguration", "HealingSpell", "DarkCharm", "Jinx", "Curse", "MagicalTransportation", "Hex", "CounterSpell", "DarkArts", "CounterJinx", "CounterCharm", "Untransfiguration", "BindingMagicalContract", "Vanishment"];
const spellLight = ["None", "Blue", "IcyBlue", "Red", "Gold", "Purple", "Transparent", "White", "Green", "Orange", "Yellow", "BrightBlue", "Pink", "Violet", "BlueishWhite", "Silver", "Scarlet", "Fire", "FieryScarlet", "Grey", "DarkRed", "Turquoise", "PsychedelicTransparentWave", "BrightYellow", "BlackSmoke"];
let elixirs;
let spells;
...
function isSpell(object) {
    return object.incantation !== undefined;
}
function isElixir(object) {
    return object.ingredients !== undefined;
}
const check = (object) => {
    if (isSpell(object)) {
